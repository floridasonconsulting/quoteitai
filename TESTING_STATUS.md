...
- ✅ **CRITICAL FIX**: Fixed Vitest module hoisting issue - moved ENTIRE Supabase mock object creation into `vi.hoisted()` scope (not just factories) to ensure the mock is fully constructed BEFORE any module imports
