...
- ✅ **CRITICAL FIX**: Fixed Vitest module hoisting issue - wrapped all mock factories in `vi.hoisted()` to ensure they're created BEFORE any module imports, preventing "is not a function" errors across all test files
