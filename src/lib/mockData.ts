...
export const MOCK_QUOTES: Quote[] = [
    {
        ...
        title: 'Penthouse Automation & Smart Integration',
        status: 'accepted',
        items: [
            {
                itemId: 'demo-item-1',
    ...
    },
    {
        ...
        title: 'Resort-Wide Filtration Overhaul',
        status: 'accepted',
        items: [
            {
                itemId: 'demo-item-4',
    ...
    },
    {
        ...
        customerId: 'demo-cust-1',
        customerName: 'Luxury Estates Management',
        title: 'Annual Maintenance Master Contract',
        status: 'accepted',
        items: [
            {
                itemId: 'demo-item-3',
    ...
    },
    {
        ...
        customerId: 'demo-cust-2',
        customerName: 'Coastal Resorts & Spas',
        title: 'LED Architectural Lighting Package',
        status: 'accepted',
        items: [
            {
                itemId: 'demo-item-5',
                name: 'LED Path Light Kit',
                description: 'Deluxe Pro Set',
                category: 'Lighting',
                quantity: 25,
                price: 450.00,
                total: 11250.00,
    ...
    },
    {
        ...
        customerId: 'demo-cust-1',
        customerName: 'Luxury Estates Management',
        title: 'Smart Solar Heating Integration',
        status: 'accepted',
        items: [
            {
                itemId: 'demo-item-6',
                name: 'High-Output Solar Panels',
                description: 'Heliocol Professional',
                category: 'Equipment',
                quantity: 8,
                price: 1200.00,
                total: 9600.00,
    ...
    },
    {
        ...
        customerId: 'demo-cust-2',
        customerName: 'Coastal Resorts & Spas',
        title: 'Safety Barrier & Glass Fencing',
        status: 'accepted',
        items: [
            {
                itemId: 'demo-item-7',
                name: 'Frameless Glass Fencing',
                description: '1/2 inch tempered glass panels',
                category: 'Hardscape',
                quantity: 120,
                price: 75.00,
                total: 9000.00,
    ...
    },
    {
        ...
        customerId: 'demo-cust-1',
        customerName: 'Luxury Estates Management',
        title: 'Infinity Edge Pool Reconstruction',
        status: 'sent',
        items: [
            {
                itemId: 'demo-item-8',
                name: 'Structural Concrete & Reinforcement',
                description: 'Shotcrete application with rebar grid',
                category: 'Hardscape',
                quantity: 1,
                price: 15000.00,
                total: 15000.00,
    ...
    },
    {
        ...
        customerId: 'demo-cust-2',
        customerName: 'Coastal Resorts & Spas',
        title: 'Custom Spa Jet Array Installation',
        status: 'declined',
        items: [
            {
                itemId: 'demo-item-9',
                name: 'Custom Jet Package',
                description: 'High-flow venturi jet system',
                category: 'Equipment',
                quantity: 1,
                price: 3500.00,
                total: 3500.00,
