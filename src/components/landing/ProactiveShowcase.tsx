                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div className="space-y-8">
                        ...
                        <h2 className="text-3xl md:text-5xl font-black text-white tracking-tighter leading-tight">
                            Anticipate Your Customer’s Needs—<span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Automatically.</span>
                        </h2>
                    ...
                    <div className="relative">
                        ...
                        <div className="rounded-2xl md:rounded-3xl border border-white/10 bg-[#07090C]/50 backdrop-blur-xl p-4 md:p-8 shadow-2xl relative overflow-hidden aspect-square sm:aspect-[4/3] flex flex-col">
                            {/* Header */}
                            ...
                            <div className="space-y-6 flex-1">
                                ...
                                <div className="mt-8 border-2 border-primary/30 rounded-2xl p-6 bg-primary/5 relative">
                                    <div className="absolute -top-3 left-6 px-3 py-0.5 bg-primary text-primary-foreground text-[10px] font-black uppercase rounded-full">
                                    ...
                                    <AnimatePresence>
                                        {step === 1 && (
                                            <motion.div
                                                ...
                                                exit={{ opacity: 0 }}
                                                className="absolute text-primary z-50 pointer-events-none"
                                            >
                                                <MousePointer2 className="w-6 h-6 md:w-8 md:h-8 fill-primary" />
                                                <span className="ml-5 mt-2 inline-block px-2 py-1 bg-white text-black text-[8px] md:text-[10px] font-bold rounded shadow-lg whitespace-nowrap">
                                                    Customer lingering...
                                                </span>
                                            </motion.div>
                                        )}
                            ...
                            <AnimatePresence>
                                {step >= 2 && (
                                    ...
                                    >
                                        <GlassCard className="w-48 md:w-64 p-0 shadow-2xl border-primary/50 bg-[#07090C] shadow-primary/20">
                                            ...
                                            <div className="p-4 space-y-3">
                                                {step === 2 ? (
                                                    <>
                                                        ...
                                                        <div className="h-8 bg-white/5 rounded-md flex items-center px-3 text-[10px] text-white/40">
                                                            Type your question...
                                                        </div>
                                                        <div className="h-8 bg-primary rounded-md flex items-center justify-center text-[10px] text-primary-foreground font-bold gap-2">
                        ...
                        <motion.div
                            ...
                            className="absolute -top-6 -right-6 h-20 w-20 bg-primary rounded-2xl flex items-center justify-center shadow-2xl z-20"
                        >
